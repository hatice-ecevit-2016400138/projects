...
public:
    Multiplication(int _id, string _name="mult");
    void doForward();
    void doBackward();
};
...
public:
    Addition(int _id, string _name="add");
    void doForward();
    void doBackward();
};
...
public:
    Cosine(int _id, string _name="cos");
    void doForward();
    void doBackward();
};
class Identity : public Function{
public:
    Identity(int _id, string _name="identity");
    void doForward();
    void doBackward();
};
class Tangent : public Function{
public:
    Tangent(int _id, string _name="tan");
    void doForward();
    void doBackward();
};
class ArcCosine : public Function{
public:
    ArcCosine(int _id, string _name="acos");
    void doForward();
    void doBackward();
};
class ArcSine : public Function{
public:
    ArcSine(int _id, string _name="asin");
    void doForward();
    void doBackward();
};
...
public:
    ArcTangent(int _id, string _name="atan");
    void doForward();
    void doBackward();
};
class Exponential : public Function{
public:
    Exponential(int _id, string _name="exp");
    void doForward();
    void doBackward();
};
class Log : public Function{
public:
    Log(int _id, string _name="log");
    void doForward();
    void doBackward();
};
class Log10: public Function{
public:
    Log10(int _id, string _name="log10");
    void doForward();
    void doBackward();
};
class Power : public Function{
public:
    Power(int _id, string _name="pow");
    void doForward();
    void doBackward();
};
class Sqrt : public Function{
public:
    Sqrt(int _id, string _name="sqrt");
    void doForward();
    void doBackward();
};
class Subtraction : public Function{
public:
    Subtraction(int _id, string _name="subs");
    void doForward();
    void doBackward();
};
class Division : public Function{
public:
    Division(int _id, string _name="div");
    void doForward();
    void doBackward();
};
#endif // VARIABLEclass